...
class VisualTemplateManager:
    def __init__(self, **kwargs):
        ...
        self.VT_MATCH_THRESHOLD = 2.4  # This threshold determines whether a new vt is generated
        # self.history = []
        # define the x, y range of visual template img
        self.VT_IMG_CROP_Y_RANGE = kwargs.pop("VT_IMG_CROP_Y_RANGE", slice(0, 180))
        self.VT_IMG_CROP_X_RANGE = kwargs.pop("VT_IMG_CROP_X_RANGE", slice(0, 320))
        # define resized range of visual template img for reducing resolution
        self.VT_IMG_RESIZE_X_RANGE = kwargs.pop("VT_IMG_RESIZE_X_RANGE", 45)
        self.VT_IMG_RESIZE_Y_RANGE = kwargs.pop("VT_IMG_RESIZE_Y_RANGE", 80)
        ...
        if self.NUM_VT < 4:
            ...
            if diff > self.VT_MATCH_THRESHOLD:
                ...
                if self.PREV_VT_ID != vt_id:
                    ...
                    # self.history.append([diff, vt_id])
