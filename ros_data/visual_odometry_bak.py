...
class VisualOdometry:
    def __init__(self, **kwargs):
        ...
        self.ODO_IMG_TRANS_Y_RANGE = kwargs.pop("ODO_IMG_TRANS_Y_RANGE", slice(20, 160))
        self.ODO_IMG_TRANS_X_RANGE = kwargs.pop("ODO_IMG_TRANS_X_RANGE", slice(10, 310))
        self.ODO_IMG_HEIGHT_V_Y_RANGE = kwargs.pop("ODO_IMG_HEIGHT_V_Y_RANGE", slice(20, 160))
        self.ODO_IMG_HEIGHT_V_X_RANGE = kwargs.pop("ODO_IMG_HEIGHT_V_X_RANGE", slice(10, 310))
        self.ODO_IMG_YAW_ROT_Y_RANGE = kwargs.pop("ODO_IMG_YAW_ROT_Y_RANGE", slice(20, 160))
        self.ODO_IMG_YAW_ROT_X_RANGE = kwargs.pop("ODO_IMG_YAW_ROT_X_RANGE", slice(10, 310))
        # define the size of resized images for odo
        self.ODO_IMG_TRANS_RESIZE_RANGE = [180, 320]
        self.ODO_IMG_YAW_ROT_RESIZE_RANGE = [180, 320]
        self.ODO_IMG_HEIGHT_V_RESIZE_RANGE = [180, 320]
        ...
        self.ODO_SHIFT_MATCH_VERT = kwargs.pop("ODO_SHIFT_MATCH_VERT", 40)
        self.ODO_SHIFT_MATCH_HORI = kwargs.pop("ODO_SHIFT_MATCH_HORI", 40)
        
        # define the degree of the field of view in horizontal and vertical
        self.FOV_HORI_DEGREE = kwargs.pop("FOV_HORI_DEGREE", 85)
    ...
    def compare_segments(seg1, seg2, shift_length, compare_length_of_intensity):
        ...
        for offset in range(shift_length + 1):
            ...
            # compare_difference_segments = (seg1[: compare_length_of_intensity - offset] -
            #                                      seg2[offset: compare_length_of_intensity])
            # sum_compare_difference_segments = np.linalg.norm(compare_difference_segments)
