...
class VisualTemplateManager:
    def __init__(self, **kwargs):
        ...
        self.VT_MATCH_THRESHOLD = kwargs.pop("VT_MATCH_THRESHOLD", 3.4)   # This threshold determines whether a new vt is generated
        
        # define the x, y range of visual template img
        self.VT_IMG_CROP_Y_RANGE = kwargs.pop("VT_IMG_CROP_Y_RANGE", slice(0, 270))
        if type(self.VT_IMG_CROP_Y_RANGE) == list:
            self.VT_IMG_CROP_Y_RANGE = slice(self.VT_IMG_CROP_Y_RANGE[0] ,self.VT_IMG_CROP_Y_RANGE[1])
